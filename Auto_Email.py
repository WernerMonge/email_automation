...
try:
    excel_file = 'C:/Users/alemo/Desktop/Empleados.xlsx' #Archivo con la información sobre los empleados del departamento
    df_empleados= pd.read_excel(excel_file)
    outlook = client.Dispatch('Outlook.Application')
    namespace = outlook.GetNamespace('MAPI')
    account = namespace.Folders['alemonge2107@outlook.com']
    inbox = account.Folders['Inbox']
    sports_folder = inbox.Folders['SportsMed']
    OW_folder = inbox.Folders['Ortho and Wounds']
    excel_file = 'C:/Users/alemo/Desktop/History.xlsx' #Archivo con los casos y su respectivo dueño
